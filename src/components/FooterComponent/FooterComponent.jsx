  ...
  return (
    <section className={styleFooter.sectionFooter} id = "contatos">
      <div className={styleFooter.logoFooter}>
        <img src="https://raw.githubusercontent.com/EriclysLuckas/Lash/refs/heads/main/img/logo.png" alt="" />
      </div>
      <div className={styleFooter.contentFooter}>
        ...
        <div className={styleFooter.imgProfissional}> <img src="https://raw.githubusercontent.com/EriclysLuckas/Lash/refs/heads/main/img/profissional.png" alt="" />
        </div>
      </div >
